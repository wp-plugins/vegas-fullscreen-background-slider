...
<p>Shortcode: <input type="text" spellcheck="false" onclick="this.focus();this.select()" readonly="readonly" value='<?php $shortcodeid = get_the_ID(); echo '[vegasslider id="' . $shortcodeid . '" fade="1000"]';?>'></p>
...
extract(shortcode_atts(array('id','fade' => '1500','overlay','title','arrows','delay' => '4000'), $atts));
