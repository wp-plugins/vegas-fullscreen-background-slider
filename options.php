  ...
  public function check_title($input){ 
   ...
   return $Global;
    ...
    public function fade_field(){
        ?><input type="text" id="fade" name="fade_key[Fade]" value="<?=get_option('fade');?>" /><?php
    }
    public function delay_field(){
        ?><input type="text" id="delay" name="delay_key[Delay]" value="<?=get_option('delay');?>" /><?php
    }
    public function overlay_field(){
        ?><input type="text" id="overlay" name="overlay_key[Overlay]" value="<?=get_option('overlay');?>" /><?php
    }
    public function title_field(){
        ?><input type="text" id="title" name="title_key[Title]" value="<?=get_option('title');?>" /><?php
    }
    ...
    public function autoplay_field(){
        ?><input type="checkbox" id="autoplay" name="autoplay_key[Autoplay]" value="1" <?php $Autoplay = get_option('autoplay'); checked( $Autoplay['autoplay'], 1  ) ; ?>/><?php
    }
    public function global_field(){
        ?><input type="checkbox" id="global" name="global_key[Global]" value="1" <?php $Global = get_option('global'); checked( $Global['global'], 1  ) ; ?>/><?php
    }
    public function id_field(){
    $global = get_option('global');
        ?><input type="text" id="id" name="id_key[Id]" value="<?=get_option('id');?>" <?php if($global != 1){echo 'disabled="disabled"';} ?> /><br/>
